...
Pour permettre la connexion avec Facebook, il faut créer une application Facebook dédiée au site concerné et indiquer les clés d'accès à l'application dans la configuration du plugin (Tutoriel : http://www.designaesthetic.com/2012/03/02/create-facebook-login-oauth-php-sdk/ )
